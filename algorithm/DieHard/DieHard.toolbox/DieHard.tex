...
\@x{ {\EXTENDS} Integers}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLES} bigJug ,\, smallJug}%
\@pvspace{16.0pt}%
\@x{ TypeOk \.{\defeq} \.{\land} smallJug \.{\in} 0 \.{\dotdot} 3}%
\@x{\@s{52.67} \.{\land} bigJug \.{\in} 0 \.{\dotdot} 5}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq} \.{\land} bigJug \.{=} 0}%
\@x{\@s{35.70} \.{\land} smallJug \.{=} 0}%
\@pvspace{24.0pt}%
\@x{ Min ( m ,\, n ) \.{\defeq} {\IF} m \.{<} n \.{\THEN} m \.{\ELSE} n}%
\@pvspace{24.0pt}%
\@x{ FillSmallJug \.{\defeq} \.{\land} smallJug \.{'} \.{=} 3}%
\@x{\@s{55.85} \.{\land}\@s{7.77} bigJug \.{'} \.{=} bigJug}%
\@pvspace{8.0pt}%
\@x{ FillBigJug \.{\defeq} \.{\land} bigJug \.{'} \.{=} 5}%
\@x{\@s{64.91} \.{\land} smallJug \.{'} \.{=} smallJug}%
\@pvspace{8.0pt}%
\@x{ EmptySmallJug \.{\defeq} \.{\land} smallJug \.{'} \.{=} 0}%
\@x{\@s{87.77} \.{\land} bigJug \.{'}\@s{0.90} \.{=} bigJug}%
\@pvspace{8.0pt}%
\@x{ EmptyBigJug \.{\defeq} \.{\land} smallJug \.{'} \.{=} smallJug}%
\@x{\@s{86.14} \.{\land} bigJug \.{'}\@s{2.53} \.{=} 0}%
\@pvspace{8.0pt}%
\@x{ SmallToBig \.{\defeq}}%
\@x{ \.{\LET}}%
 \@x{\@s{16.4} pouredAmount \.{\defeq} Min ( bigJug \.{+} smallJug ,\, 5 )
 \.{-} bigJug}%
\@x{ \.{\IN}}%
\@x{\@s{16.4} \.{\land} bigJug \.{'} \.{=} bigJug \.{+} pouredAmount}%
\@x{\@s{16.4} \.{\land} smallJug \.{'} \.{=} smallJug \.{-} pouredAmount}%
\@pvspace{8.0pt}%
\@x{ BigToSmall \.{\defeq}}%
\@x{ \.{\LET}}%
 \@x{\@s{16.4} pouredAmount \.{\defeq} Min ( bigJug \.{+} smallJug ,\, 3 )
 \.{-} smallJug}%
\@x{ \.{\IN}}%
\@x{\@s{16.4} \.{\land} bigJug \.{'} \.{=} bigJug \.{-} pouredAmount}%
\@x{\@s{16.4} \.{\land} smallJug \.{'} \.{=} smallJug \.{+} pouredAmount}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} \.{\lor} FillSmallJug}%
\@x{\@s{39.83} \.{\lor} FillBigJug}%
\@x{\@s{39.83} \.{\lor} EmptySmallJug}%
\@x{\@s{39.83} \.{\lor} EmptyBigJug}%
\@x{\@s{39.83} \.{\lor} SmallToBig}%
\@x{\@s{39.83} \.{\lor} BigToSmall}%
\@pvspace{8.0pt}%
\@x{ DefuseBomb \.{\defeq} bigJug \.{\neq} 4}%
\@y{\@s{0}%
 Look for a violation which is the solution....
}%
\@xx{}%
\@pvspace{56.0pt}%
\@x{}\bottombar\@xx{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Mar} 03 17:23:52 \ensuremath{MST} 2021 by \ensuremath{jeremy
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Wed} \ensuremath{Mar} 03
 16:20:33 \ensuremath{MST} 2021 by \ensuremath{jeremy
}%
\end{cpar}%
\end{lcom}%
\end{document}
