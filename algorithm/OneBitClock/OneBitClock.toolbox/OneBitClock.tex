...
\@x{ {\VARIABLE} b}%
\@pvspace{8.0pt}%
\@x{ Init1\@s{4.12} \.{\defeq} ( b \.{=} 0 ) \.{\lor} ( b \.{=} 1 )}%
\@x{ Next1 \.{\defeq} \.{\lor} \.{\land} b\@s{4.1} \.{=} 0}%
\@x{\@s{55.94} \.{\land} b \.{'}\@s{1.29} \.{=} 1}%
\@x{\@s{44.83} \.{\lor} \.{\land} b\@s{4.09} \.{=} 1}%
\@x{\@s{55.94} \.{\land} b \.{'}\@s{1.29} \.{=} 0}%
\@pvspace{16.0pt}%
\@x{ TypeOk \.{\defeq} b \.{\in} \{ 0 ,\, 1 \}}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Feb} 26 23:28:23 \ensuremath{MST} 2021 by \ensuremath{jeremy
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Fri} \ensuremath{Feb} 26
 23:17:57 \ensuremath{MST} 2021 by \ensuremath{jeremy
}%
\end{cpar}%
\end{lcom}%
\end{document}
