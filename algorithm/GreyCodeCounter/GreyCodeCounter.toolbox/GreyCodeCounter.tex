...
\@x{ {\p@while} {\p@lparen} {\TRUE} {\p@rparen} {\p@lbrace}}%
 ...
 {\p@rparen} {\p@lbrace}}%
 \@x{\@s{35.24} actions . before \.{:=} {\langle} 0 ,\, 0 {\rangle}
 {\p@semicolon}}%
\@x{\@s{35.24} flashCell \.{:=} {\langle} 1 ,\, 1 {\rangle} {\p@semicolon}}%
 \@x{\@s{35.24} actions . after \.{:=} {\langle} 1 ,\, 1 {\rangle}
 {\p@semicolon}}%
\@x{\@s{16.4} {\p@rbrace}}%
\@x{\@s{16.4} {\p@else}}%
 \@x{\@s{16.4} actions . before \.{:=} {\langle} 0 ,\, 0 {\rangle}
 {\p@semicolon}}%
\@x{\@s{32.8} flashCell \.{:=} {\langle} 1 ,\, 1 {\rangle} {\p@semicolon}}%
 \@x{\@s{32.8} actions . after \.{:=} {\langle} 1 ,\, 1 {\rangle}
 {\p@semicolon}}%
\@x{\@s{28.69} {\p@rbrace}}%
\@x{ {\p@rbrace}}%
\@x{ {\p@rbrace}}%
...
\@x{}%
\@y{\@s{0}%
 BEGIN TRANSLATION (\ensuremath{chksum(pcal) \.{=}} ``\ensuremath{58c9e3f0}''
 \ensuremath{\.{\land} chksum(tla) \.{=}} ``\ensuremath{8860fb5f}'')
}%
\@xx{}%
...
\@x{\@s{42.84} \.{\land} {\IF} flashCell \.{=} {\langle} 0 ,\, 0 {\rangle}}%
 \@x{\@s{66.11} \.{\THEN} \.{\land} actions \.{'} \.{=} [ actions {\EXCEPT}
 {\bang} . before \.{=} {\langle} 0 ,\, 0 {\rangle} ]}%
\@x{\@s{97.42} \.{\land} flashCell \.{'} \.{=} {\langle} 1 ,\, 1 {\rangle}}%
\@x{\@s{97.42} \.{\land} pc \.{'} \.{=}\@w{Lbl\_2}}%
 \@x{\@s{66.11} \.{\ELSE} \.{\land} actions \.{'} \.{=} [ actions {\EXCEPT}
 {\bang} . before \.{=} {\langle} 0 ,\, 0 {\rangle} ]}%
\@x{\@s{97.42} \.{\land} pc \.{'} \.{=}\@w{Lbl\_3}}%
\@x{\@s{97.42} \.{\land} {\UNCHANGED} flashCell}%
\@pvspace{8.0pt}%
\@x{ Lbl\_3 \.{\defeq} \.{\land} pc \.{=}\@w{Lbl\_3}}%
\@x{\@s{42.84} \.{\land} flashCell \.{'} \.{=} {\langle} 1 ,\, 1 {\rangle}}%
...
\@x{ Lbl\_2 \.{\defeq} \.{\land} pc \.{=}\@w{Lbl\_2}}%
 \@x{\@s{42.84} \.{\land} actions \.{'} \.{=} [ actions {\EXCEPT} {\bang} .
 after \.{=} {\langle} 1 ,\, 1 {\rangle} ]}%
\@x{\@s{42.84} \.{\land} pc \.{'} \.{=}\@w{Lbl\_3}}%
\@x{\@s{42.84} \.{\land} {\UNCHANGED} flashCell}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} Lbl\_1 \.{\lor} Lbl\_3 \.{\lor} Lbl\_2}%
\@pvspace{8.0pt}%
...
\@x{}%
\@y{\@s{0}%
 Only 1 bit can change between two states.
 \ensuremath{{\langle}0,\,0{\rangle} \.{\rightarrow} {\langle}1,\,1{\rangle}}
...
\@x{\@s{16.4} \.{\THEN}}%
 \@x{\@s{32.8} ( actions . after [ 1 ] \.{+} actions . after [ 2 ] ) \.{-} (
 actions . before [ 1 ] \.{+} actions . after [ 2 ] ) \.{\in} \{ 1 \}}%
\@x{\@s{16.4} \.{\ELSE} {\TRUE}}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Mar} 02 17:00:40 \ensuremath{MST} 2021 by \ensuremath{jeremy
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
