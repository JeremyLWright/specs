...
\end{cpar}%
\end{lcom}%
 \@x{ OneBitAtATime \.{\defeq} {\IF} actions . before \.{\neq} {\langle}
 {\rangle} \.{\land} actions . after \.{\neq} {\langle} {\rangle}}%
\@x{\@s{16.4} \.{\THEN}}%
 \@x{\@s{36.9} ( actions . after [ 1 ] \.{+} actions . after [ 2 ] ) \.{-} (
 actions . before [ 1 ] \.{+} actions . before [ 2 ] )\@s{4.1} \.{\in} \{
 \.{-} 1 ,\, 0 ,\, 1 \}}%
\@x{\@s{16.4} \.{\ELSE} {\TRUE}}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Mar} 02 18:33:42 \ensuremath{MST} 2021 by \ensuremath{jeremy
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
