...
\@x{}\moduleLeftDash\@xx{ {\MODULE} GreyCodeCounter}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Sequences ,\, Integers ,\, TLC}%
\@pvspace{8.0pt}%
\begin{lcom}{2.5}%
\begin{cpar}{0}{T}{F}{5.0}{0}{}%
 Grey Code is a way of encoding binary information such that no two bits flip
 in one step.
\end{cpar}%
...
\pcalshadingtrue
\csyntaxtrue
\@x{\@s{8.2} {\p@mmalgorithm} GreyCode {\p@lbrace}}%
\@pvspace{8.0pt}%
\@x{ {\p@variables}}%
 \@x{\@s{16.4} flashCell \.{\in} \{ {\langle} 0 ,\, 0 {\rangle} ,\, {\langle}
 0 ,\, 1 {\rangle} ,\, {\langle} 1 ,\, 1 {\rangle} ,\, {\langle} 1 ,\, 0
 {\rangle} \} {\p@semicolon}}%
 \@x{\@s{16.4} actions \.{=} [ before \.{\mapsto} {\langle} {\rangle} ,\,
 after \.{\mapsto} {\langle} {\rangle} ] {\p@semicolon}}%
\@x{ {\p@lbrace}}%
\@pvspace{8.0pt}%
\@x{ {\p@while} {\p@lparen} {\TRUE} {\p@rparen} {\p@lbrace}}%
\@x{\@s{16.4} actions . before \.{:=} flashCell {\p@semicolon}}%
 \@x{\@s{16.4} {\p@if} {\p@lparen} flashCell \.{=} {\langle} 0 ,\, 0 {\rangle}
 {\p@rparen} {\p@lbrace}}%
\@pvspace{8.0pt}%
\@x{\@s{35.24} flashCell \.{:=} {\langle} 0 ,\, 1 {\rangle} {\p@semicolon}}%
 \@x{\@s{35.24} actions . after \.{:=} {\langle} 0 ,\, 1 {\rangle}
 {\p@semicolon}}%
\@pvspace{8.0pt}%
 \@x{\@s{16.4} {\p@rbrace} {\p@else} {\p@if} {\p@lparen} flashCell \.{=}
 {\langle} 0 ,\, 1 {\rangle} {\p@rparen} {\p@lbrace}}%
\@x{\@s{38.01} flashCell \.{:=} {\langle} 1 ,\, 1 {\rangle} {\p@semicolon}}%
 \@x{\@s{38.01} actions . after \.{:=} {\langle} 1 ,\, 1 {\rangle}
 {\p@semicolon}}%
\@pvspace{8.0pt}%
 \@x{\@s{16.4} {\p@rbrace} {\p@else} {\p@if} {\p@lparen} flashCell \.{=}
 {\langle} 1 ,\, 0 {\rangle} {\p@rparen} {\p@lbrace}}%
\@pvspace{8.0pt}%
\@x{\@s{38.01} flashCell \.{:=} {\langle} 0 ,\, 0 {\rangle} {\p@semicolon}}%
 \@x{\@s{38.01} actions . after \.{:=} {\langle} 0 ,\, 0 {\rangle}
 {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{\@s{16.4} {\p@rbrace} {\p@else} {\p@lbrace}}%
\@pvspace{8.0pt}%
\@x{\@s{38.01} flashCell \.{:=} {\langle} 1 ,\, 0 {\rangle} {\p@semicolon}}%
 \@x{\@s{38.01} actions . after \.{:=} {\langle} 1 ,\, 0 {\rangle}
 {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{\@s{16.4} {\p@rbrace}}%
\@pvspace{8.0pt}%
...
\@x{}%
\@y{\@s{0}%
 BEGIN TRANSLATION (\ensuremath{chksum(pcal) \.{=}} ``\ensuremath{f604e792}''
 \ensuremath{\.{\land} chksum(tla) \.{=}} ``\ensuremath{ce051695}'')
}%
\@xx{}%
\@x{ {\VARIABLES} flashCell ,\, actions ,\, pc}%
\@pvspace{8.0pt}%
\@x{ vars \.{\defeq} {\langle} flashCell ,\, actions ,\, pc {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Init\@s{2.02} \.{\defeq}}%
\@y{\@s{0}%
 Global variables
...
\@xx{}%
 \@x{\@s{37.72} \.{\land} flashCell \.{\in} \{ {\langle} 0 ,\, 0 {\rangle} ,\,
 {\langle} 0 ,\, 1 {\rangle} ,\, {\langle} 1 ,\, 1 {\rangle} ,\, {\langle} 1
 ,\, 0 {\rangle} \}}%
 \@x{\@s{37.72} \.{\land} actions \.{=} [ before \.{\mapsto} {\langle}
 {\rangle} ,\, after \.{\mapsto} {\langle} {\rangle} ]}%
\@x{\@s{37.72} \.{\land} pc \.{=}\@w{Lbl\_1}}%
\@pvspace{8.0pt}%
\@x{ Lbl\_1 \.{\defeq} \.{\land} pc \.{=}\@w{Lbl\_1}}%
 \@x{\@s{42.84} \.{\land} actions \.{'} \.{=} [ actions {\EXCEPT} {\bang} .
 before \.{=} flashCell ]}%
\@x{\@s{42.84} \.{\land} {\IF} flashCell \.{=} {\langle} 0 ,\, 0 {\rangle}}%
 \@x{\@s{66.11} \.{\THEN} \.{\land} flashCell \.{'} \.{=} {\langle} 0 ,\, 1
 {\rangle}}%
\@x{\@s{97.42} \.{\land} pc \.{'} \.{=}\@w{Lbl\_2}}%
 \@x{\@s{66.11} \.{\ELSE} \.{\land} {\IF} flashCell \.{=} {\langle} 0 ,\, 1
 {\rangle}}%
 \@x{\@s{120.69} \.{\THEN} \.{\land} flashCell \.{'} \.{=} {\langle} 1 ,\, 1
 {\rangle}}%
\@x{\@s{152.00} \.{\land} pc \.{'} \.{=}\@w{Lbl\_3}}%
 \@x{\@s{120.69} \.{\ELSE} \.{\land} {\IF} flashCell \.{=} {\langle} 1 ,\, 0
 {\rangle}}%
 \@x{\@s{175.27} \.{\THEN} \.{\land} flashCell \.{'} \.{=} {\langle} 0 ,\, 0
 {\rangle}}%
\@x{\@s{206.58} \.{\land} pc \.{'} \.{=}\@w{Lbl\_4}}%
 \@x{\@s{175.27} \.{\ELSE} \.{\land} flashCell \.{'} \.{=} {\langle} 1 ,\, 0
 {\rangle}}%
\@x{\@s{206.58} \.{\land} pc \.{'} \.{=}\@w{Lbl\_5}}%
\@pvspace{8.0pt}%
\@x{ Lbl\_2 \.{\defeq} \.{\land} pc \.{=}\@w{Lbl\_2}}%
 \@x{\@s{42.84} \.{\land} actions \.{'} \.{=} [ actions {\EXCEPT} {\bang} .
 after \.{=} {\langle} 0 ,\, 1 {\rangle} ]}%
\@x{\@s{42.84} \.{\land} pc \.{'} \.{=}\@w{Lbl\_1}}%
\@x{\@s{42.84} \.{\land} {\UNCHANGED} flashCell}%
\@pvspace{8.0pt}%
\@x{ Lbl\_3 \.{\defeq} \.{\land} pc \.{=}\@w{Lbl\_3}}%
 \@x{\@s{42.84} \.{\land} actions \.{'} \.{=} [ actions {\EXCEPT} {\bang} .
 after \.{=} {\langle} 1 ,\, 1 {\rangle} ]}%
\@x{\@s{42.84} \.{\land} pc \.{'} \.{=}\@w{Lbl\_1}}%
\@x{\@s{42.84} \.{\land} {\UNCHANGED} flashCell}%
\@pvspace{8.0pt}%
\@x{ Lbl\_4 \.{\defeq} \.{\land} pc \.{=}\@w{Lbl\_4}}%
 \@x{\@s{42.84} \.{\land} actions \.{'} \.{=} [ actions {\EXCEPT} {\bang} .
 after \.{=} {\langle} 0 ,\, 0 {\rangle} ]}%
\@x{\@s{42.84} \.{\land} pc \.{'} \.{=}\@w{Lbl\_1}}%
\@x{\@s{42.84} \.{\land} {\UNCHANGED} flashCell}%
\@pvspace{8.0pt}%
\@x{ Lbl\_5 \.{\defeq} \.{\land} pc \.{=}\@w{Lbl\_5}}%
 \@x{\@s{42.84} \.{\land} actions \.{'} \.{=} [ actions {\EXCEPT} {\bang} .
 after \.{=} {\langle} 1 ,\, 0 {\rangle} ]}%
\@x{\@s{42.84} \.{\land} pc \.{'} \.{=}\@w{Lbl\_1}}%
\@x{\@s{42.84} \.{\land} {\UNCHANGED} flashCell}%
\@pvspace{8.0pt}%
 \@x{ Next \.{\defeq} Lbl\_1 \.{\lor} Lbl\_2 \.{\lor} Lbl\_3 \.{\lor} Lbl\_4
 \.{\lor} Lbl\_5}%
\@pvspace{8.0pt}%
...
\@x{}%
\@y{\@s{0}%
 \ensuremath{{\Box}[NextVariables]} ``OR'' \ensuremath{\_unchanged\_vars
}}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{}%
...
\@xx{}%
\@pvspace{16.0pt}%
 \@x{ TypeOk \.{\defeq} flashCell [ 1 ] \.{\in} \{ 0 ,\, 1 \} \.{\land}
 flashCell [ 2 ] \.{\in} \{ 0 ,\, 1 \}}%
\@y{\@s{0}%
 They are 1 indexed!
}%
...
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 Only 1 bit can change between two states. \ensuremath{{\langle}0,\,0{\rangle}
 \.{\rightarrow} {\langle}1,\,1{\rangle}} is an illegal transition.
 Hence, ``distance'' between any two states is \ensuremath{\.{\,|\,} \{0,\,
 1\} \.{\,|\,}
}%
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{OneBitAtATime \.{\defeq} {\IF}} \ensuremath{actions.before
 \.{\neq} {\langle}{\rangle} \.{\land} actions.after \.{\neq}
 {\langle}{\rangle}
}%
\end{cpar}%
...
\begin{cpar}{0}{T}{F}{12.5}{0}{}%
 (\ensuremath{actions.after[1] \.{+} actions.after[2]) \.{-}
 (actions.before[1] \.{+} actions.before[2]}) \ensuremath{\.{\in} \{\.{-}1,\,
 0,\, 1\}
}%
\end{cpar}%
\begin{cpar}{1}{F}{F}{0}{0}{}%
\ensuremath{\.{\ELSE} {\TRUE}
}%
\end{cpar}%
\end{lcom}%
\@x{ OurFriendship \.{\defeq} HackingDay \.{\implies} {\Box} ( Friends )}%
\@pvspace{16.0pt}%
\@x{}%
\@y{%
 \ensuremath{OneBitAtATime \.{\defeq}} (\ensuremath{flashCell\.{'}[1] \.{+}
 flashCell\.{'}[2] \.{-} (flashCell[1] \.{+} flashCell[2]}))
 \ensuremath{\.{\in} \{\.{-}1,\,0,\,1\}
}}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{}%
\@y{%
 \ensuremath{AlwaysOneBitAtATime \.{\defeq} {\Box}([OneBitAtATime]\_flashCell)
}}%
\@xx{}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Mar} 05 10:26:11 \ensuremath{MST} 2021 by \ensuremath{jeremy
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Tue} \ensuremath{Mar} 02
 16:05:58 \ensuremath{MST} 2021 by \ensuremath{jeremy
}%
\end{cpar}%
\end{lcom}%
\end{document}
