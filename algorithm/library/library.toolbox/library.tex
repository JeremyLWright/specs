...
\@x{}\moduleLeftDash\@xx{ {\MODULE} library}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Naturals ,\, Integers ,\, TLC ,\, Sequences}%
\@pvspace{8.0pt}%
\@x{ PT \.{\defeq} {\INSTANCE} PT}%
\@pvspace{8.0pt}%
\@x{ {\CONSTANTS} Books ,\, People ,\, NumCopies}%
\@pvspace{8.0pt}%
\@x{ {\ASSUME} NumCopies \.{\subseteq} Nat}%
\@y{\@s{0}%
 The number of copies you can checkout is a natural number
}%
\@xx{}%
\@pvspace{32.0pt}%
\@x{}%
...
\@xx{}%
\@x{ set \.{\pp} x \.{\defeq} set \.{\cup} \{ x \}}%
\@x{ set \.{\mm} x \.{\defeq} set \.{\,\backslash\,} \{ x \}}%
\@pvspace{16.0pt}%
\pcalsymbolstrue
\pcalshadingtrue
\csyntaxfalse
\@x{\@s{8.2} {\p@mmalgorithm} library}%
\@pvspace{8.0pt}%
\@x{ {\p@variables}}%
\@x{\@s{16.4} library \.{\in} [ Books \.{\rightarrow} NumCopies ] ,\,}%
\@y{\@s{0}%
 The library is a set of books, each with a number of \ensuremath{\.{>}0}
 copies.
}%
\@xx{}%
 \@x{\@s{16.4} reserves \.{=} [ b \.{\in} Books \.{\mapsto} {\langle}
 {\rangle} ] {\p@semicolon}}%
\@y{\@s{0}%
 Initially,the library has no active reservations
}%
\@xx{}%
\@x{}%
\@y{\@s{0}%
...
\@pvspace{24.0pt}%
\@x{ {\p@define}}%
 \@x{\@s{16.4} AvailableBooks \.{\defeq} \{ b \.{\in} Books \.{:} library [ b
 ] \.{>} 0 \}}%
\@y{\@s{0}%
 a book is available if it\mbox{'}s in the library and it\mbox{'}s count is
 greater than 0
}%
\@xx{}%
 \@x{\@s{16.4} BorrowableBooks ( p ) \.{\defeq} \{ b \.{\in} AvailableBooks
 \.{:}}%
\@x{\@s{32.8} \.{\lor} reserves [ b ] \.{=} {\langle} {\rangle}}%
\@x{\@s{32.8} \.{\lor} p \.{=} Head ( reserves [ b ] ) \}}%
\@x{\@s{36.89}}%
\@y{\@s{0}%
...
\@pvspace{8.0pt}%
\@x{ {\p@fair} {\p@process} person \.{\in} People}%
\@x{ {\p@variables}}%
\@x{\@s{16.4} books\@s{2.30} \.{=} \{ \} ,\,}%
\@y{\@s{0}%
 The books they have\.{?} \ensuremath{TODO} \ensuremath{JLW}, Why is this not
 \ensuremath{my\_private
}}%
\@xx{}%
\@x{\@s{16.4} wants \.{\in} {\SUBSET} Books {\p@semicolon}}%
\@x{ {\p@begin}}%
\@x{\@s{16.4} Person\@s{.5}\textrm{:}\@s{3}}%
...
\@xx{}%
 \@x{\@s{49.19} {\p@with} b \.{\in} ( BorrowableBooks ( self ) \.{\cap} wants
 ) \.{\,\backslash\,} books {\p@do}}%
\@x{\@s{65.6} library [ b ] \.{:=} library [ b ] \.{-} 1 {\p@semicolon}}%
\@y{\@s{0}%
 decrement the count in the library
}%
\@xx{}%
\@x{\@s{65.6} books\@s{2.30} \.{:=} books\@s{2.30} \.{\pp} b {\p@semicolon}}%
\@x{\@s{65.6} wants \.{:=} wants \.{\mm} b {\p@semicolon}}%
 \@x{\@s{65.6} {\p@if} reserves [ b ] \.{\neq} {\langle} {\rangle} \.{\land}
 self \.{=} Head ( reserves [ b ] ) {\p@then}}%
\@x{\@s{80.24} reserves [ b ] \.{:=} Tail ( reserves [ b ] ) {\p@semicolon}}%
\@x{\@s{65.6} {\p@end} {\p@if} {\p@semicolon}}%
\@x{\@s{49.19} {\p@end} {\p@with} {\p@semicolon}}%
\@x{\@s{32.8} {\p@or}}%
\@x{\@s{49.19}}%
\@y{\@s{0}%
 Return
...
\@xx{}%
\@x{\@s{49.19} {\p@with} b \.{\in} books {\p@do}}%
\@x{\@s{65.6} library [ b ] \.{:=} library [ b ] \.{+} 1 {\p@semicolon}}%
\@y{\@s{0}%
 put it back in the library
}%
\@xx{}%
\@x{\@s{65.6} books \.{:=} books \.{\mm} b {\p@semicolon}}%
\@x{\@s{49.19} {\p@end} {\p@with} {\p@semicolon}}%
\@x{\@s{32.8} {\p@or}}%
\@x{\@s{49.19}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\@s{49.19} {\p@with} b \.{\in} \{ b \.{\in} Books \.{:} self
 \.{\notin}\@s{4.1} PT {\bang} Range ( reserves [ b ] ) \} {\p@do}}%
 \@x{\@s{65.6} reserves [ b ] \.{:=} Append ( reserves [ b ] ,\, self )
 {\p@semicolon}}%
\@y{\@s{0}%
 Find a book I want to reserve
}%
\@xx{}%
\@x{\@s{49.19} {\p@end} {\p@with} {\p@semicolon}}%
\@x{\@s{32.8} {\p@or}}%
...
\@xx{}%
\@x{\@s{49.19} {\p@with} b \.{\in} Books \.{\,\backslash\,} wants {\p@do}}%
\@x{\@s{65.6} wants \.{:=} wants \.{\pp} b {\p@semicolon}}%
\@x{\@s{49.19} {\p@end} {\p@with} {\p@semicolon}}%
\@x{\@s{32.8} {\p@end} {\p@either} {\p@semicolon}}%
\@x{\@s{16.4} {\p@end} {\p@while} {\p@semicolon}}%
\@x{\@s{16.4} {\p@goto} Person {\p@semicolon}}%
\@x{ {\p@end} {\p@process}}%
\@pvspace{32.0pt}%
\@x{ {\p@end} {\p@algorithm}}%
\@y{%
...
\@x{}%
\@y{\@s{0}%
 BEGIN TRANSLATION (\ensuremath{chksum(pcal) \.{=}} ``\ensuremath{c051bee3}''
 \ensuremath{\.{\land} chksum(tla) \.{=}} ``\ensuremath{493425c7}'')
}%
\@xx{}%
\@x{ {\VARIABLES} library ,\, reserves ,\, pc}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 define statement
...
\@xx{}%
 \@x{ AvailableBooks \.{\defeq} \{ b \.{\in} Books \.{:} library [ b ] \.{>} 0
 \}}%
\@x{ BorrowableBooks ( p ) \.{\defeq} \{ b \.{\in} AvailableBooks \.{:}}%
\@x{\@s{16.4} \.{\lor} reserves [ b ] \.{=} {\langle} {\rangle}}%
\@x{\@s{16.4} \.{\lor} p \.{=} Head ( reserves [ b ] ) \}}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLES} books ,\, wants}%
\@pvspace{8.0pt}%
 \@x{ vars \.{\defeq} {\langle} library ,\, reserves ,\, pc ,\, books ,\,
 wants {\rangle}}%
\@pvspace{8.0pt}%
\@x{ ProcSet \.{\defeq} ( People )}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq}}%
\@y{\@s{0}%
 Global variables
...
\@xx{}%
\@x{\@s{35.70} \.{\land} library \.{\in} [ Books \.{\rightarrow} NumCopies ]}%
 \@x{\@s{35.70} \.{\land} reserves \.{=} [ b \.{\in} Books \.{\mapsto}
 {\langle} {\rangle} ]}%
\@x{\@s{35.70}}%
\@y{\@s{0}%
 Process person
...
\@xx{}%
 \@x{\@s{35.70} \.{\land} books\@s{2.30} \.{=} [ self \.{\in} People
 \.{\mapsto} \{ \} ]}%
 \@x{\@s{35.70} \.{\land} wants \.{\in} [ People \.{\rightarrow} {\SUBSET}
 Books ]}%
 \@x{\@s{35.70} \.{\land} pc \.{=} [ self \.{\in} ProcSet
 \.{\mapsto}\@w{Person} ]}%
\@pvspace{8.0pt}%
\@x{ Person ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{Person}}%
 \@x{\@s{74.28} \.{\land} \.{\lor} \.{\land} \E\, b \.{\in} ( BorrowableBooks
 ( self ) \.{\cap} wants [ self ] ) \.{\,\backslash\,} books [ self ] \.{:}}%
 \@x{\@s{115.81} \.{\land} library \.{'} \.{=} [ library {\EXCEPT} {\bang} [ b
 ] \.{=} library [ b ] \.{-} 1 ]}%
 \@x{\@s{115.81} \.{\land} books \.{'}\@s{2.30} \.{=} [ books {\EXCEPT}
 {\bang} [ self ]\@s{2.30} \.{=} books [ self ]\@s{2.30} \.{\pp} b ]}%
 \@x{\@s{115.81} \.{\land} wants \.{'} \.{=} [ wants {\EXCEPT} {\bang} [ self
 ] \.{=} wants [ self ] \.{\mm} b ]}%
 \@x{\@s{115.81} \.{\land} {\IF} reserves [ b ] \.{\neq} {\langle} {\rangle}
 \.{\land} self\@s{31.79} \.{=} Head ( reserves [ b ] )}%
 \@x{\@s{139.08} \.{\THEN} \.{\land} reserves \.{'} \.{=} [ reserves {\EXCEPT}
 {\bang} [ b ] \.{=} Tail ( reserves [ b ] ) ]}%
\@x{\@s{139.08} \.{\ELSE} \.{\land} {\TRUE}}%
\@x{\@s{170.39} \.{\land} {\UNCHANGED} reserves}%
\@x{\@s{85.39} \.{\lor} \.{\land} \E\, b \.{\in} books [ self ] \.{:}}%
 \@x{\@s{115.81} \.{\land} library \.{'} \.{=} [ library {\EXCEPT} {\bang} [ b
 ] \.{=} library [ b ] \.{+} 1 ]}%
 \@x{\@s{115.81} \.{\land} books \.{'} \.{=} [ books {\EXCEPT} {\bang} [ self
 ] \.{=} books [ self ] \.{\mm} b ]}%
\@x{\@s{96.50} \.{\land} {\UNCHANGED} {\langle} reserves ,\, wants {\rangle}}%
 \@x{\@s{85.39} \.{\lor} \.{\land} \E\, b \.{\in} \{ b\@s{10.30} \.{\in} Books
 \.{:} self \.{\notin}\@s{4.1} PT {\bang} Range ( reserves [ b ] ) \} \.{:}}%
 \@x{\@s{115.81} reserves \.{'} \.{=} [ reserves {\EXCEPT} {\bang} [ b ] \.{=}
 Append ( reserves [ b ] ,\, self ) ]}%
 \@x{\@s{96.50} \.{\land} {\UNCHANGED} {\langle} library ,\, books ,\, wants
 {\rangle}}%
 \@x{\@s{85.39} \.{\lor} \.{\land} \E\, b \.{\in} Books \.{\,\backslash\,}
 wants [ self ] \.{:}}%
 \@x{\@s{115.81} wants \.{'} \.{=} [ wants {\EXCEPT} {\bang} [ self ] \.{=}
 wants [ self ] \.{\pp} b ]}%
 \@x{\@s{96.50} \.{\land} {\UNCHANGED} {\langle} library ,\, reserves ,\,
 books {\rangle}}%
 \@x{\@s{74.28} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{Person} ]}%
\@pvspace{8.0pt}%
\@x{ person ( self )\@s{2.18} \.{\defeq} Person ( self )}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} ( \E\, self \.{\in} People \.{:} person ( self ) )}%
\@x{\@s{47.82} \.{\lor} Terminating}%
\@pvspace{8.0pt}%
 \@x{ Spec\@s{1.46} \.{\defeq} \.{\land} Init \.{\land} {\Box} [ Next ]_{
 vars}}%
 \@x{\@s{39.83} \.{\land} \A\, self \.{\in} People \.{:} {\WF}_{ vars} (
 person ( self ) )}%
\@pvspace{8.0pt}%
...
\@xx{}%
\@pvspace{8.0pt}%
\@x{ NoDuplicateReservations \.{\defeq}}%
\@x{\@s{16.4} \A\, b \.{\in} Books \.{:}}%
 \@x{\@s{27.72} \A\, i ,\, j \.{\in} 1 \.{\dotdot} Len ( reserves [ b ] )
 \.{:}}%
 \@x{\@s{39.03} i \.{\neq} j \.{\implies} reserves [ b ] [ i ] \.{\neq}
 reserves [ b ] [ j ]}%
\@pvspace{8.0pt}%
\@x{ TypeInvariant \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} library \.{\in} [ Books \.{\rightarrow} NumCopies
 \.{\pp} 0 ]}%
\@y{\@s{0}%
 library is always a map of books to number of copies or 0
}%
\@xx{}%
 \@x{\@s{16.4} \.{\land} books\@s{2.30} \.{\in} [ People \.{\rightarrow}
 {\SUBSET} Books ]}%
\@y{\@s{0}%
 people never have books that aren\mbox{'}t from the library
}%
\@xx{}%
 \@x{\@s{16.4} \.{\land} wants \.{\in} [ People \.{\rightarrow} {\SUBSET}
 Books ]}%
\@y{\@s{0}%
 People can only want books we have
}%
\@xx{}%
 \@x{\@s{16.4} \.{\land} reserves \.{\in} [ Books \.{\rightarrow} Seq ( People
 ) ]}%
\@x{\@s{16.4} \.{\land} NoDuplicateReservations}%
\@pvspace{8.0pt}%
\@x{ Liveness \.{\defeq}}%
\@x{\@s{16.4} \A\, p \.{\in} People \.{:}}%
\@x{\@s{27.72} \A\, b \.{\in} Books \.{:}}%
\@x{\@s{39.04} b \.{\in} wants [ p ] \.{\leadsto} b \.{\notin} wants [ p ]}%
\@pvspace{8.0pt}%
\@x{\@s{16.4}}%
\@y{%
 \ensuremath{\.{\land} {\Diamond}(\A\, p \.{\in} People\.{:} wants[p] \.{=}
 \{\}) \.{\,\backslash\,}}* Eventually you always get what you want.
}%
\@xx{}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Feb} 17 17:06:05 \ensuremath{MST} 2021 by \ensuremath{jeremy
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Wed} \ensuremath{Feb} 17
 09:26:49 \ensuremath{MST} 2021 by \ensuremath{jeremy
}%
\end{cpar}%
\end{lcom}%
\end{document}
